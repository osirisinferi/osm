=== OSM - OpenStreetMap ===
Contributors: MiKa
Tags: map, OpenStreetMap, Google Maps, googlemaps, geo, KML, GPX, geotag, geolocation, geocache, geocaching, OSM, travelogue, OpenLayers, marker, POI, geocode, geotagging, location, Tracks, WMS, OpenWeatherMap, fullscreen, OpenSeaMap, stamen, basemap, exif, meta, widget
